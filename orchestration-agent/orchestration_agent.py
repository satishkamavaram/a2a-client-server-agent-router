...
def main(host: str = DEFAULT_HOST, port: int = DEFAULT_PORT):
    ...
    skill = AgentSkill(
        ...
        description='You are an Orchestration Agent capable of routing requests to appropriate specialists: database query agents for SQL generation and result analysis, or requirement verification agents for project compliance checking.',
        tags=['db', 'sql', 'postgres', 'requirement', 'verification'],
        examples=['show me largest sale happened in 2025',
                  ...
                  'Please verify in AI-postgresdb repo , requirement is  implemented correctly.'],
    )
