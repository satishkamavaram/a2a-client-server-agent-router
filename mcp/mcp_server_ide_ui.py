...
# Keep audience unset so one server can validate both:
# 1) IDE OAuth-issued access tokens (aud can vary/omit in this setup)
# 2) UI bearer JWT tokens (same issuer/JWKS)
